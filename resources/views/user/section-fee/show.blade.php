...
@section('page-content')
    <div class="custom-container">
        ...
        <div class="flex justify-between items-center mt-4">
            ...
            <a href="{{ route('user.section.fee.edit', [$section, $voucher->id]) }}" class="btn-blue rounded"><i
        ...
        <div class="text-center mt-8">
            <a href="{{ route('user.section.fee.index', $section) }}" class="btn-blue rounded py-2 px-5">Close</a>
        </div>
    </div>
    <script>
