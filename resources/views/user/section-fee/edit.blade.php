...
@section('page-content')
    <div class="custom-container">
        ...
        <div class="bread-crumb">
            ...
            <div>/</div>
            <a href="{{ route('user.section.fee.index', $section) }}">Fee</a>
        </div>
        ...
        <div class="overflow-x-auto bg-white w-full mt-4">
            <form action="{{ route('user.section.fee.update', [$section, $voucher]) }}" method="post" class="mt-3">
                @csrf
                @method('PATCH')
                ...
                <div class="text-center mt-8">
                    <a href="{{ route('user.section.fee.index', $section) }}" class="btn-gray rounded py-2 mr-3">Cancel</a>
