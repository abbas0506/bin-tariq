...
@section('page-content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        @if ($section)
            <a href="{{ route('user.students.index') }}" class="pallet-box bg-gradient-to-r from-teal-100 to-white ">
                <div class="flex-1">
                    <h2>My Class</h2>
        ...
        @else
            <a href="{{ route('user.my-schedule.index') }}" class="pallet-box bg-gradient-to-r from-teal-100 to-white ">
                <div class="flex-1 items-center">
                    <h2>My Schedule</h2>
                    <p class="text-xs text-slate-400">Lectures Count:
                        {{ Auth::user()->user?->allocations->count() }}
        ...
        @endif
        <a href="{{ route('user.tests.index') }}" class="pallet-box bg-gradient-to-r from-indigo-100 to-white">
            <div class="flex-1 items-center">
                <h2>Assessment</h2>
