    ...
    <div class="custom-container">
        ...
        <div class="md:w-4/5 mx-auto bg-white md:p-8 p-4 rounded border mt-12">
            <div class="grid text-center gap-8">
                ...
                @if ($present)
                    <a href="{{ route('user.section.attendance.show', [$section, 1]) }}" class="btn-blue rounded py-2">
                        View Attendance</a>
                @else
                    <a href="{{ route('user.section.attendance.create', $section) }}" class="btn-blue rounded py-2">
                        Start Attendance</a>
                @endif
