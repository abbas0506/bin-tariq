...
@section('page-content')
    <div class="custom-container">
        ...
        <div class="bread-crumb">
            <a href="{{ url('/') }}">Home</a>
            <div>/</div>
            <a href="{{ route('user.students.index', $section) }}">{{ $section->name }}</a>
            <div>/</div>
        ...
        <div class="content-section relative">
            <div class="w-full md:w-2/3 mx-auto mt-8">
                ...
                <form action="{{ route('user.students.store') }}" method='post' class="mt-4"
                    ...
                    <div class="text-right text-sm mt-8">
                        <!-- close button -->
                        <a href="{{ route('user.students.index', $section) }}" class="btn-gray py-2 rounded">Cancel</a>
