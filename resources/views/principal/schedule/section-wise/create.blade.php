...
@section('page-content')
    ...
    <div class="bread-crumb">
        <a href="/">Home</a>
        <div>/</div>
        <a href="{{ route('principal.section.lecture.schedule.index', [0, 0]) }}">Allocations</a>
        <div>/</div>
        <div>New</div>
    </div>
    ...
    <div class="md:w-3/4 mx-auto mt-6 bg-white md:p-8 rounded">
        ...
        <form action="{{ route('principal.section.lecture.schedule.store', [$section, $lecture_no]) }}" method='post'
