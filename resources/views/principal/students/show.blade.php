        ...
        <div class="absolute top-2 right-2">
            <div class="flex items-center justify-center space-x-2">
                <div class="flex w-8 h-8 rounded-full border justify-center items-center">
                    <form action="{{ route('principal.section.students.destroy', [$section, $student]) }}" method="post"
                ...
                <div class="flex w-8 h-8 rounded-full border justify-center items-center">
                    <a href="{{ route('principal.section.students.edit', [$section, $student]) }}">
                        <i class="bx-pencil text-green-600"></i></a>
                </div>
                <div class="flex w-8 h-8 rounded-full border justify-center items-center">
                    <a href="{{ route('principal.sections.show', $section) }}"><i class="bi-x-lg"></i></a>
                </div>
            </div>
        </div>
