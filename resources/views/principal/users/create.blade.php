...
@section('page-content')
    <div class="custom-container">
        ...
        <div class="md:w-4/5 border rounded mx-auto mt-12 p-5 md:p-8 relative">
            <!-- close button -->
            <a href="{{ route('principal.users.index') }}" class="absolute top-2 right-2 p-2 hover:bg-slate-200 rounded"><i
                    class="bi-x-lg"></i></a>
            ...
            <div class="w-full mt-8">
                ...
                <form action="{{ route('principal.users.store') }}" method='post' class="mt-4"
