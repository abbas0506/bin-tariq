...
@section('page-content')
    ...
    <div class="custom-container">
        ...
        <div class="md:w-4/5 mx-auto mt-6 bg-white md:p-8 p-4 rounded border relative">
            ...
            <form action="{{ route('principal.user.roles.update', [Auth::user()->id, 1]) }}" method='post' class="">
                @csrf
                @method('PATCH')
                ...
                <div class="flex justify-end space-x-3 text-center mt-8 md:col-span-2">
                    <a href="{{ route('principal.users.index') }}" class="btn-gray rounded py-2 px-3">Cancel </a>
