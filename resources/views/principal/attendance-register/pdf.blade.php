            ...
            @foreach ($monthData as $month)
                @foreach ($userChunks as $users)
                    <div class="page-break page-container">
                        <!-- Background Logo -->
                        <img src="{{ public_path('images/logo/bin_tariq.png') }}" class="bg-logo" alt="Logo">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    @foreach ($users as $user)
                                        @if ($user)
                                            <th colspan="4" style="font-size:12px">{{ $user->profile->name }}
                                                </br>
                                                <span style="font-size: 10px">{{ $user->designation }}</span>
                                            </th>
                                        @else
                                            <th colspan="4">&nbsp;</th>
                                        @endif
                            ...
                            <tbody>
                                ...
                                @endfor
                                <tr>
                                    <th colspan="{{ $users->count() * 4 + 1 }}">LEAVE RECORD</th>
                                </tr>
                                <tr>
                                    <th></th>
                                    @foreach ($users as $user)
