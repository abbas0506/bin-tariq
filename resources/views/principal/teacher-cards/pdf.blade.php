    ...
    <main>
        <div class="custom-container">
            <table class="w-full">
                <tbody>
                    <tr class="text-xs">
                        <td class="text-left">user Cards</td>
                        ...
                        <td class="p-6">
                            <div class="border p-2 card-container">
                                ...
                                <img src="{{ public_path('images/bg/waves.png') }}" class="wave-pattern"
                                    alt="Wave pattern">
                                <img src="{{ public_path('images/logo/bin_tariq.png') }}" alt="" class="logo">
                                ...
                                <div class="footer">ID: {{ $user->cnic }}</div>
                                <!-- Foreground Content -->
