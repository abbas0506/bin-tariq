...
@section('page-content')
    <div class="custom-container">
        ...
        <div class="bread-crumb">
            ...
            <div>/</div>
            <a href="{{ route('principal.attendance.index') }}">Attendance</a>
            <div>/</div>
                        ...
                        @foreach ($attendances->sortBy('status') as $attendance)
                            <tr class="tr">
                                ...
                                <td class="text-left text-xs md:text-sm">
                                    <a href="{{ route('principal.attendance.show', $attendance->student) }}"
        ...
        <div class="text-center mt-8">
            <a href="{{ route('principal.attendance.index') }}" class="btn-blue rounded py-2 px-5">Close</a>
        </div>
    </div>
    <script>
