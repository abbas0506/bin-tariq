...
@section('page-content')
    <div class="custom-container">
        ...
        <div class="md:w-4/5 mx-auto bg-white mt-8">
            ...
            {{-- filter form  --}}
            <form action="{{ route('principal.attendance.filter') }}" method="POST" id="form_filter">
                @csrf
        ...
        <div class="md:w-4/5 mx-auto bg-white md:p-8 p-4 rounded border mt-3 relative">
            ...
            <form action="{{ route('principal.attendance.clear') }}" method="POST" id="form_clear"
                ...
                <tbody>
                    @foreach ($sections as $section)
                        @if ($section->attendance_count)
                            <tr class="tr">
                                <td class="text-left">
                                    <a href="{{ route('principal.attendance.byDate', ['section' => $section, 'date' => $date]) }}"
