...
class StudentController extends Controller
{
    ...
    {
        //
        $section = Auth::user()->sectionAsIncharge();
        return view('user.students.index', compact('section'));
    }
    ...
    public function create()
    {
        ...
        return view('user.students.create', compact('section'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('user.students.index')->with('success', 'Successfully created');
        } catch (Exception $e) {
    ...
    public function show(string $id)
    {
        ...
        return view('user.students.show', compact('section', 'student'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $section = Auth::user()->user?->sectionAsIncharge();
        $student = Student::findOrFail($id);
        return view('user.students.edit', compact('section', 'student'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            return redirect()->route('user.students.index')->with('success', 'Student successfully updated');
        } catch (Exception $e) {
            return redirect()->back()->withErrors($e->getMessage());
            // something went wrong
        }
    ...
    {
        $section = Auth::user()->sectionAsIncharge();
        $pdf = PDF::loadview('user.students.print', compact('section'))->setPaper('a4', 'portrait');
