...
class FeeController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('user.section-fee.index', compact('section', 'vouchers'));
    }
    ...
    public function show($sectionId, $voucherId)
    {
        ...
        $students = Student::where('section_id', $sectionId)
            ...
            ->get();
        return view('user.section-fee.show', compact('section', 'voucher', 'students'));
    }
    ...
    public function edit($sectionId, $voucherId)
    {
        ...
        return view('user.section-fee.edit', compact('section', 'fees', 'voucher'));
    }
    ...
    public function update(Request $request, $sectionId, $voucherId)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('user.section.fee.show', [$sectionId, $voucherId])->with('success', 'fee successfully updated');
        } catch (Exception $e) {
            DB::rollBack();
