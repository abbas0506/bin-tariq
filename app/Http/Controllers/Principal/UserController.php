...
class userController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('principal.users.index')->with('success', 'Successfully created');
        } catch (Exception $e) {
    ...
    public function show(string $id)
    {
        ...
        $roles = Role::all();
        return view('principal.users.show', compact('user', 'roles'));
    }
    ...
    public function update(Request $request, user $user)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('principal.users.show', $user)->with('success', 'user updated successfully.');
        } catch (Exception $ex) {
            DB::rollBack();
