...
class AttendanceRegisterController extends Controller
{
    ...
    {
        //
        $users = User::all()->sortBy('seniority');
        $userChunks = $users->chunk(4)->map(function ($chunk) {
            return $chunk->pad(4, null);
        });
        // $userChunks = $users->chunk(4);
        ...
        return $pdf->stream("user_Attendance_Register_$year.pdf");
    }
