...
class SectionWiseScheduleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('principal.schedule.section-wise.index', compact('sections', 'lectures'));
    }
    ...
    public function print()
    {
        ...
        $lectures = Lecture::all();
        $pdf = PDF::loadview('principal.schedule.section-wise.pdf', compact('sections', 'lectures'))->setPaper('a4', 'landscape');
    ...
    public function post(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('principal.class-schedule.print');
        } catch (Exception $e) {
