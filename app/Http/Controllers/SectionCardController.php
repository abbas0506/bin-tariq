...
class SectionCardController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('sections.cards.index', compact('section'));
    }
    ...
    public function store(Request $request, $section)
    {
        ...
        try {
            ...
            return redirect()->route('section.cards.print', $section);
        } catch (Exception $e) {
    ...
    public function print()
    {
        if (session('students')) {
            ...
            $pdf = PDF::loadview('sections.cards.print', compact('students'))->setPaper('a4', 'portrait');
